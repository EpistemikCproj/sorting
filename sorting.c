		...
		if( choice < 7 )
		  {
			...
			if ( n <= 209 )
			  PrintArray(A, n) ;
				...
				fprintf(stdout, "%u ...array is TOO BIG to print... %u\n\n",A[1],A[n]) ;
			...
			switch( choice )
			 {
			  case  1: HeapSort(A,n) ; break ;
			  case  2: QuickSort(A,1,n) ; break ;
			  case  3: SelectionSort(A,n) ; break ;
			  case  4: RadixSort(A,n) ; break ;
			  case  5: BigRadixSort(A,n) ; break ;
			  case  6: ArrayRadixSort(A,n) ; break ;
			  default: break ;
			 }/* switch */
				 ...
				 switch( choice )
				  {
					...
					case  8: QuickSort(A,1,n) ; break ;
					case  9: SelectionSort(A,n) ; break ;
					case 10: RadixSort(A,n) ; break ;
					case 11: BigRadixSort(A,n) ; break ;
					case 12: ArrayRadixSort(A,n) ; break ;
					default: break ;
				  }/* switch */
...
/* MakeRandomArray()
	...
	postconditions: A[1..n] has been initialized with random numbers
						 in the range 1..MAXINT		*/
